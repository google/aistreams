...
#ifndef AISTREAMS_GSTREAMER_GST_PLUGINS_AISSINK_CLI_BUILDER_H_
#define AISTREAMS_GSTREAMER_GST_PLUGINS_AISSINK_CLI_BUILDER_H_
...
#endif  // AISTREAMS_GSTREAMER_GST_PLUGINS_AISSINK_CLI_BUILDER_H_
